...
namespace GestorVentas_FLOMA.Controllers
{
    public class ClienteController : Controller
    {
        ...
        public ClienteController(FlomaContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        public string ObtenerDomcilioCliente(int idCliente)
        {
            ...
            {
                return ""; // O cualquier otro valor por defecto que decidas
            }
        }
        // GET: Clientes/Create
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Direccion,Celular,Fuente")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Direccion,Celular,Fuente")] Cliente cliente)
        {
            if (id != cliente.Id)
            {
                return NotFound();
